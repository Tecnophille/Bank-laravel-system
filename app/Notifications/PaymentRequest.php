...
class PaymentRequest extends Notification {
    ...
    public function toTwilioSms($notifiable) {
        ...
        return (new SmsMessage())
            ->setContent("Dear Sir, Your have received new payment request of $amount on $dateTime")
    ...
    public function toArray($notifiable) {
        ...
        $dateTime = $this->paymentRequest->created_at;
        return [
            'message' => "Dear Sir, Your have received new payment request of $amount on $dateTime",
        ];
    }
}
