...
class FDRMatured extends Notification {
    ...
    public function toTwilioSms($notifiable) {
        ...
        return (new SmsMessage())
            ->setContent("Dear Sir, Your FDR is already matured. Your account has been credited by $amount on $dateTime")
    ...
    public function toArray($notifiable) {
        ...
        $dateTime = $this->transaction->created_at;
        return [
            'message' => "Dear Sir, Your FDR is already matured. Your account has been credited by $amount on $dateTime",
        ];
    }
}
