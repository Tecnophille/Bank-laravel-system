...
class RejectWithdrawRequest extends Notification {
    ...
    public function toTwilioSms($notifiable) {
        ...
        return (new SmsMessage())
            ->setContent("Dear Sir, Your withdraw request has been rejected. Your transferd amount $amount has returned back to your account.")
    ...
    public function toArray($notifiable) {
        ...
        $dateTime = $this->transaction->created_at;
        return [
            'message' => "Dear Sir, Your withdraw request has been rejected. Your transferd amount $amount has returned back to your account.",
        ];
    }
}
